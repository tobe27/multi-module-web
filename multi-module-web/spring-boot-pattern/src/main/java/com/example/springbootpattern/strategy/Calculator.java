...
/**
 * 行为型模式-策略模式（Strategy Pattern）中，一个类的行为或其算法可以在运行时更改。
 *
...
public class Calculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("加法策略： 2 + 5 = " + calculator.getResult(2, 5));
        System.out.println("==============================");

        calculator.setStrategy(new Subtraction());
        System.out.println("减法策略： 5 - 3 = " + calculator.getResult(5, 3));
    }
}
