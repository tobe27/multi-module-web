...
/**
 * 在行为型模式-模板模式（Template Pattern）中，一个抽象类公开定义了执行它的方法的方式/模板。它的子类可以按需要重写方法实现，但调用将以抽象类中定义的方式进行。
 *
 * 介绍
...
public abstract class AbstractPM {
    ...
    /**
     * 项目开发流程，模板方法用final限定不能更改，只需要实现相应的方法即可
     */
    ...
    public static void main(String[] args) {
        // IOS开发流程
        AbstractPM iosPM = new IosPM();
        iosPM.kickoff();

        System.out.println("=============================");

        // ANDROID开发流程
        AbstractPM androidPM = new AndroidPM();
        androidPM.kickoff();
    }
}
